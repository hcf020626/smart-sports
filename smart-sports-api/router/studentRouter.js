...
CREATE TABLE `t_student_physical_test` (
  ...
  `push_ups` int(11) DEFAULT NULL COMMENT '俯卧撑，单位：个数',
  `pull_ups` int(11) DEFAULT NULL COMMENT '引体向上，单位：个数',
  `shuttle_run` decimal(4,1) DEFAULT NULL COMMENT '折返跑，单位：秒（s）',
  `1000m_run` decimal(5,2) DEFAULT NULL COMMENT '1000米跑，单位：秒（s）',
  `50m_sprint` decimal(4,2) DEFAULT NULL COMMENT '50米跑，单位：秒（s）',
